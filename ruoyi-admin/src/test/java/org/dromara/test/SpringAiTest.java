...
public class SpringAiTest {
    ...
    @Test
    public void test() {
        ChatClient.CallResponseSpec youAreAHelpfulAssistant = openAiChatClient.prompt("你是一个java应用专家").user("jdk21虚拟线程原理是什么").advisors(x -> x.param(ChatMemory.CONVERSATION_ID, 77)).call();
